...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        ...
        description='Program that takes a list of directories, searches for books in those directories, and tries to '
                    'put files of the same book that are in different formats into the same directory.',
...
def main():
    ...
    dirs = DEFAULT_DIRS | set(map(lambda x: Path(x), args.directories))
